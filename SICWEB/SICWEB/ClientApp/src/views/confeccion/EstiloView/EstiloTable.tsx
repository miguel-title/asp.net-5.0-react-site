              ...
              {paginatedStyles.map((item, index) => {
                return (
                  ...
                  >
                    ...
                    <TableCell>
                     {sizeString(item.sizeName)}
                    </TableCell>
                    <TableCell align="right">
                      <Tooltip title="Editar" aria-label="Editar">
                        <Button size="small" onClick={()=>handleProcess(item.estilo_c_iid, item)} color="primary">{'Procesos'}</Button>
                      </Tooltip>
                    </TableCell>
                    <TableCell align="right">
                      <Tooltip title="Editar" aria-label="Editar">
                        <Button size="small" onClick={()=>handleInsumos(item.estilo_c_iid, item)} color="primary">{'Insumos'}</Button>
                      </Tooltip>
                    </TableCell>
                  </TableRow>
                );
