                    ...
                    <Form onSubmit={handleSubmit}>
                        <Box p={3}>
                            <Typography
                                ...
                                color="textPrimary"
                            >
                                {editID > -1 ? 'Editar Cliente / Proveedor' : 'Nuevo Cliente / Proveedor'}
                            </Typography>
                        </Box>
                        <Divider />
                        <Box p={3}>
                            <Grid container spacing={3}>
                                <Grid item xl={4} lg={4} md={4} sm={4} xs={12}>
                                    ...
                                    // defaultValue={0}
                                    >
                                        <option key={0} value={0}> {'NATURAL'} </option>
                                        <option key={1} value={1}> {'JURÍDICA'} </option>
                                        <option key={2} value={2}> {'EXTRANJERO'} </option>
                                    </TextField>
                                </Grid>
                                <Grid item xl={4} lg={4} md={4} sm={4} xs={12}>
                                    <TextField
